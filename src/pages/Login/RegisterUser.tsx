...
import useRegisterUser from '@/pages/Login/hooks/useRegisterUser'
...
const Login = () => {
    const { step, data, images, handleFormSubmit } = useRegisterUser()
                ...
                {step === 1 ? (
                    <div className={'block gap-20 lg:grid lg:grid-cols-2'}>
                                ...
                                <div className={'flex flex-col gap-5 items-center text-[white]'}>
                                    ...
                                    <div className={'flex flex-col gap-1 items-center'}>
                                        ...
                                        <span className={'text-[18px] font-light'}>
                                            Cadastra-se agora com seu e-mail
                                        </span>
                                    </div>
                                </div>
                        ...
                        <div className={'hidden lg:flex flex-col h-full w-full items-center'}>
                            <div
                                className={
                                    'flex flex-col items-center bg-btn-primary bg-clip-text font-oxanium text-transparent'
                                }
                            >
                            ...
                            <div className={'flex gap-4 flex-wrap justify-center'}>
                                {images &&
                                    images.map((image, index) => (
                                        <img
                                            key={index}
                                            className={'rounded-[10px] display-image'}
                                            src={image}
                                            alt={'Elden ring'}
                                        />
                                    ))}
                    ...
                    <>
                        <div className={'h-full flex flex-col gap-8 items-center py-6'}>
                            ...
                            <div>
                                <ConfirmRegister name={data?.name} email={data?.email} />
                            </div>
                        </div>
                    </>
                )}
